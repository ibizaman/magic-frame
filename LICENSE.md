...
**Copyright © 2026 Jeremia Arslan**

This software is released under the **Polyform Noncommercial License
1.0.0** — an open-source-style license that permits everything except
commercial use.
...
| | |
|---|---|
| **Use** | ✅ Free (personal, household, club, NGO, school) |
| **Modify** | ✅ Free (custom changes, forks, custom modules) |
| **Distribute** | ✅ Free, as long as non-commercial (forks, mirrors, patches) |
| **Contribute** | ✅ Very welcome — pull requests, issues, ideas |
| **Run in your own smart home** | ✅ Free |
| **Deploy on your own tablets / monitors / picture frames** | ✅ Free |
| **Share with friends, family, clubs** | ✅ Free |
| **Commercial sale, SaaS offering, embed in products** | ❌ Separate license required |

If you want to use Magic Frame commercially, please email
**magicframeapp@gmail.com** — we usually find a fair arrangement.
...
Pull requests and issues are very welcome. By contributing code, you
agree that your contribution is published under this same license. You
retain authorship of your commits in the Git history.

## Scope

This license applies to all code in this repository, **except**:

- Dependencies in `node_modules/` (see their respective licenses)
- Wallpaper assets in `public/weather/` (license of the respective source)
- Example modules in `examples/` (also under this license)
